import styles from './MoodEntity.module.css'
...
function Pearl() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      ...
      <circle cx="90" cy="90" r="52" fill="url(#pearlGrad)" className={styles.pearlOrb} />
...
function Moon() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      ...
      <circle cx="90" cy="90" r="55" fill="url(#moonGrad)" className={styles.moonSway} />
...
function Forest() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      ...
      <ellipse cx="90" cy="90" rx="62" ry="55" fill="url(#forestGrad)" className={styles.forestBreath} />
...
function Velvet() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      <defs>
        <radialGradient id="velvetGrad" cx="50%" cy="40%" r="60%">
          <stop offset="0%" stopColor="#6b1f2a" />
          <stop offset="55%" stopColor="#3d1a5c" />
          <stop offset="100%" stopColor="#1a1410" />
        </radialGradient>
      </defs>
      <ellipse cx="90" cy="90" rx="58" ry="48" fill="url(#velvetGrad)" className={styles.velvetPulse} />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      ...
      <g className={styles.roseSpin}>
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.7" />
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.7" transform="rotate(60 90 90)" />
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.7" transform="rotate(120 90 90)" />
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.6" transform="rotate(180 90 90)" />
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.6" transform="rotate(240 90 90)" />
        <ellipse cx="90" cy="62" rx="22" ry="36" fill="url(#roseGrad)" opacity="0.6" transform="rotate(300 90 90)" />
      </g>
...
function Flame() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      <defs>
        <radialGradient id="flameGrad1" cx="50%" cy="80%" r="60%">
          <stop offset="0%" stopColor="#d45020" />
          <stop offset="100%" stopColor="#c01818" stopOpacity="0.1" />
        </radialGradient>
        <radialGradient id="flameGrad2" cx="50%" cy="90%" r="50%">
      ...
      <path
        ...
        fill="url(#flameGrad2)"
        className={styles.flameFlicker2}
      />
    </svg>
  )
}
...
function Mist() {
  return (
    <svg viewBox="0 0 180 180" width="180" height="180">
      <ellipse cx="90" cy="90" rx="68" ry="40" fill="rgba(154,164,160,0.18)" className={styles.mistDrift1} />
      <ellipse cx="82" cy="88" rx="55" ry="32" fill="rgba(136,152,176,0.2)" className={styles.mistDrift2} />
      <ellipse cx="98" cy="94" rx="50" ry="28" fill="rgba(138,150,128,0.18)" className={styles.mistDrift3} />
      <ellipse cx="90" cy="90" rx="38" ry="22" fill="rgba(154,164,160,0.25)" className={styles.mistDrift1} />
    </svg>
  )
}
...
export default function MoodEntity({ type }) {
